    ...
    return (
        <div>
            <div className='flex justify-center items-center'>
                <h1 className='text-3xl font-bold text-[#2e4053] text-center border-b-4 border-[#34c759] w-fit'>Dev Toolkit</h1>
            </div>
            ...
            <div className='px-5 sm:px-10 flex justify-center items-center py-10'>
                <div className='grid grid-cols-4 gap-20'>
                    ...
                    <div className='bg-[whitesmoke] divide-y-2 rounded-lg shadow-md hover:-translate-y-1 duration-200 min-h-72'>
                        ...
                        <Image src='/git-bash.svg' width={150} height={150} alt='Git Bash Icon' title='Git Bash Icon' />
                        </div>
                        <div className='p-2 flex justify-center items-center text-xl text-[#2e4053]'>
                            <p>Git Bash</p>
                        </div>
                    ...
                    <div className='bg-[whitesmoke] divide-y-2 rounded-lg shadow-md hover:-translate-y-1 duration-200 min-h-72'>
                        ...
                        <Image src='/git.svg' width={150} height={150} alt='Git Icon' title='Git Icon' />
                        </div>
                        <div className='p-2 flex justify-center items-center text-xl text-[#2e4053]'>
                            <p>Git</p>
                        </div>
                    ...
                    <div className='bg-[whitesmoke] divide-y-2 rounded-lg shadow-md hover:-translate-y-1 duration-200 min-h-72'>
                        ...
                        <Image src='/github.svg' width={150} height={150} alt='Github Icon' title='Github Icon' />
                        </div>
                        <div className='p-2 flex justify-center items-center text-xl text-[#2e4053]'>
                            <p>Github</p>
                        </div>
                    ...
                    <div className='bg-[whitesmoke] divide-y-2 rounded-lg shadow-md hover:-translate-y-1 duration-200 min-h-72'>
                        ...
                        <Image src='/framer-motion.svg' width={150} height={150} alt='Framer Motion Icon' title='Framer Motion Icon' />
                        </div>
                        <div className='p-2 flex justify-center items-center text-xl text-[#2e4053]'>
                            <p>Framer Motion</p>
                        </div>
                    ...
                    <div className='bg-[whitesmoke] divide-y-2 rounded-lg shadow-md hover:-translate-y-1 duration-200 min-h-72'>
                        ...
                        <Image src='/react-icons.svg' width={150} height={150} alt='React Icons' title='React Icons' />
                        </div>
                        <div className='p-2 flex justify-center items-center text-xl text-[#2e4053]'>
                            <p>React Icons</p>
                        </div>
